...
from sql_connector import get_functions
...
class TestGetFunctions(unittest.TestCase):
    ...
    def test_get_tour(self):
        ...
        result = get_functions.get_tour(tour_date=date(2024,2,1), attended=1, clinicians='Dr. Adams', 
    ...
    def test_get_medical_history_form(self):
        ...
        result = get_functions.get_medical_history_form(physician_name='Dr. Sarah Connor', specialty='Neurologist', 
    ...
    def test_get_attending_caregiver(self):
        ...
        result = get_functions.get_attending_caregiver(
