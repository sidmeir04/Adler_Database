...
class update_functions():
    @staticmethod
    def update_caller(
        id, staff=None, caller_name=None, caller_email=None, call_date=None, 
    ...
    @staticmethod
    def update_tour(
            id, tour_date=None, attended=None, no_join_reason=None, clinicians=None, 
    ...
    @staticmethod
    def update_member(
            id, name=None, age=None, dob=None, email=None, aep_completion_date=None, 
    ...
    def update_membership_enrollment_form(
            id, sexual_orientation=None, race=None, income=None, 
    ...
    def update_medical_history_form(
            id, physician_name=None, specialty=None, physician_address=None, 
    ...
    def update_incient_report(
            id, incident_date=None, incident_location=None, persons_involved=None, 
    ...
    def update_evaluation(
        id, completed=None, administerer=None, test_type=None, date_administered=None
    ):
        connection = create_connection()
        cursor = connection.cursor()
    ...
    def update_transportation_information(
            id, bus_transport=None, bus_company=None, bus_contact_phone=None,
    ...
    def update_caregiver(
            id, name=None, phone=None, email=None, relationship=None, date_contacted=None,
    ...
    def update_attending_caregiver(
            id, caregiver_type=None, sex=None, race=None, occupations=None, 
    ...
    def update_emergency_contact(
            id, name=None, relationship=None, day_phone=None, evening_phone=None, 
    ...
    def update_volunteer(
        id, name=None, phone=None, address=None, email=None, referral_source=None, 
    ...
    def update_applications(
            id, birthday=None, occupation=None, is_slp=None, relevant_experience=None, 
    ...
    @staticmethod
    def update_outreach(
            id, contacted_date=None, staff_contacted=None, organization=None, org_type=None, 
