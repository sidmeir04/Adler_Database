...
INSERT INTO Tour (tour_date, attended, not_joined_reason, clinicians_toured, who_attended, interactions, strategy_usage, deadline_aep, joined_after_tour, likely_to_join, additional_notes, canceled, cancel_reason) VALUES
...
INSERT INTO Member (name, age, date_of_birth, email, aep_completion_date, date_joined, schedule, phone_number, address, county, gender, veteran, joined, caregiver_needed, alder_program, member_info) VALUES
...
INSERT INTO Membership_Enrollment_Form (sexual_orientation, race, income, living_status, grew_up, occupations, previous_speech_therapy, other_therapy, hearing_loss, hearing_aid, aphasia_cause, aphasia_onset_date, location_brain, allergies, medications, filled_out_by, completion_date, patient_info) VALUES
...
INSERT INTO Medical_History_Form (physician_name, medical_specialty, physician_address, physician_phone, aphasia_cause, aphasia_onset_date, stroke_location, lesion_location, primary_medical_diagnosis, secondary_medical_diagnosis, history_of_seizures, last_seizure_date, anti_seizure_medication, allergies, medications, hearing_aid, hearing_impairment, swallowing_impairments, current_diet, compensatory_swallowing_strategies, visual_impairments, visual_field_cut, completion_date, other_conditions) VALUES
('Dr. Sarah Connor', 'Neurologist', '789 Pine St', '555-9999', 'Stroke', '2021-06-01', 'Left', 'Frontal Lobe', 'Aphasia', 'Hypertension', TRUE, '2023-12-15', FALSE, 'None', 'Lisinopril', FALSE, 'None', 'No impairments', 'Regular', FALSE, 'None', FALSE, '2024-01-20', '{"Diabetes": "No", "Heart Disease": "No", "Brain Surgery": "No", "Memory Impairment": "No", "Clinical Depression": "Yes"}');
...
INSERT INTO Transportation_Information (bus_transport, bus_company, bus_contact_phone, being_picked_up, person_picking_up, relationship_to_member, primary_phone, secondary_phone) VALUES
