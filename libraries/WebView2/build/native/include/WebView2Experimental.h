...
#ifndef __ICoreWebView2ExperimentalFrame8_FWD_DEFINED__
#define __ICoreWebView2ExperimentalFrame8_FWD_DEFINED__
typedef interface ICoreWebView2ExperimentalFrame8 ICoreWebView2ExperimentalFrame8;

#endif 	/* __ICoreWebView2ExperimentalFrame8_FWD_DEFINED__ */


#ifndef __ICoreWebView2ExperimentalFrameChildFrameCreatedEventHandler_FWD_DEFINED__
#define __ICoreWebView2ExperimentalFrameChildFrameCreatedEventHandler_FWD_DEFINED__
typedef interface ICoreWebView2ExperimentalFrameChildFrameCreatedEventHandler ICoreWebView2ExperimentalFrameChildFrameCreatedEventHandler;

#endif 	/* __ICoreWebView2ExperimentalFrameChildFrameCreatedEventHandler_FWD_DEFINED__ */
...
#ifndef __ICoreWebView2ExperimentalFrame8_INTERFACE_DEFINED__
#define __ICoreWebView2ExperimentalFrame8_INTERFACE_DEFINED__

/* interface ICoreWebView2ExperimentalFrame8 */
/* [unique][object][uuid] */ 


EXTERN_C __declspec(selectany) const IID IID_ICoreWebView2ExperimentalFrame8 = {0x639125b1,0x21f9,0x5d3a,{0x97,0xb5,0xdd,0xb5,0xa6,0xa6,0x06,0x6f}};

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("639125b1-21f9-5d3a-97b5-ddb5a6a6066f")
    ICoreWebView2ExperimentalFrame8 : public IUnknown
    {
    public:
        virtual HRESULT STDMETHODCALLTYPE add_FrameCreated( 
            /* [in] */ ICoreWebView2ExperimentalFrameChildFrameCreatedEventHandler *eventHandler,
            /* [out] */ EventRegistrationToken *token) = 0;
    ...
    typedef struct ICoreWebView2ExperimentalFrame8Vtbl
    {
        BEGIN_INTERFACE
        
        DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
        HRESULT ( STDMETHODCALLTYPE *QueryInterface )( 
            ICoreWebView2ExperimentalFrame8 * This,
            /* [in] */ REFIID riid,
            /* [annotation][iid_is][out] */ 
            _COM_Outptr_  void **ppvObject);
        ...
        DECLSPEC_XFGVIRT(ICoreWebView2ExperimentalFrame8, add_FrameCreated)
        HRESULT ( STDMETHODCALLTYPE *add_FrameCreated )( 
            ICoreWebView2ExperimentalFrame8 * This,
            /* [in] */ ICoreWebView2ExperimentalFrameChildFrameCreatedEventHandler *eventHandler,
            /* [out] */ EventRegistrationToken *token);
        
        DECLSPEC_XFGVIRT(ICoreWebView2ExperimentalFrame8, remove_FrameCreated)
        HRESULT ( STDMETHODCALLTYPE *remove_FrameCreated )( 
            ICoreWebView2ExperimentalFrame8 * This,
            /* [in] */ EventRegistrationToken token);
        
        END_INTERFACE
    } ICoreWebView2ExperimentalFrame8Vtbl;

    interface ICoreWebView2ExperimentalFrame8
    {
        CONST_VTBL struct ICoreWebView2ExperimentalFrame8Vtbl *lpVtbl;
    };
...
#define ICoreWebView2ExperimentalFrame8_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define ICoreWebView2ExperimentalFrame8_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define ICoreWebView2ExperimentalFrame8_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define ICoreWebView2ExperimentalFrame8_add_FrameCreated(This,eventHandler,token)	\
    ( (This)->lpVtbl -> add_FrameCreated(This,eventHandler,token) ) 

#define ICoreWebView2ExperimentalFrame8_remove_FrameCreated(This,token)	\
...
#endif 	/* __ICoreWebView2ExperimentalFrame8_INTERFACE_DEFINED__ */


#ifndef __ICoreWebView2ExperimentalFrameChildFrameCreatedEventHandler_INTERFACE_DEFINED__
#define __ICoreWebView2ExperimentalFrameChildFrameCreatedEventHandler_INTERFACE_DEFINED__

/* interface ICoreWebView2ExperimentalFrameChildFrameCreatedEventHandler */
/* [unique][object][uuid] */ 


EXTERN_C __declspec(selectany) const IID IID_ICoreWebView2ExperimentalFrameChildFrameCreatedEventHandler = {0x569e40e7,0x46b7,0x563d,{0x83,0xae,0x10,0x73,0x15,0x56,0x64,0xd7}};

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("569e40e7-46b7-563d-83ae-1073155664d7")
    ICoreWebView2ExperimentalFrameChildFrameCreatedEventHandler : public IUnknown
    {
    public:
        virtual HRESULT STDMETHODCALLTYPE Invoke( 
    ...
    typedef struct ICoreWebView2ExperimentalFrameChildFrameCreatedEventHandlerVtbl
    {
        BEGIN_INTERFACE
        
        DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
        HRESULT ( STDMETHODCALLTYPE *QueryInterface )( 
            ICoreWebView2ExperimentalFrameChildFrameCreatedEventHandler * This,
            /* [in] */ REFIID riid,
            /* [annotation][iid_is][out] */ 
            _COM_Outptr_  void **ppvObject);
        ...
        DECLSPEC_XFGVIRT(ICoreWebView2ExperimentalFrameChildFrameCreatedEventHandler, Invoke)
        HRESULT ( STDMETHODCALLTYPE *Invoke )( 
            ICoreWebView2ExperimentalFrameChildFrameCreatedEventHandler * This,
            /* [in] */ ICoreWebView2Frame *sender,
        ...
        END_INTERFACE
    } ICoreWebView2ExperimentalFrameChildFrameCreatedEventHandlerVtbl;

    interface ICoreWebView2ExperimentalFrameChildFrameCreatedEventHandler
    {
        CONST_VTBL struct ICoreWebView2ExperimentalFrameChildFrameCreatedEventHandlerVtbl *lpVtbl;
    };
...
#define ICoreWebView2ExperimentalFrameChildFrameCreatedEventHandler_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define ICoreWebView2ExperimentalFrameChildFrameCreatedEventHandler_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define ICoreWebView2ExperimentalFrameChildFrameCreatedEventHandler_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define ICoreWebView2ExperimentalFrameChildFrameCreatedEventHandler_Invoke(This,sender,args)	\
    ( (This)->lpVtbl -> Invoke(This,sender,args) ) 
...
#endif 	/* __ICoreWebView2ExperimentalFrameChildFrameCreatedEventHandler_INTERFACE_DEFINED__ */
